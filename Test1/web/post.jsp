...
<html>
    <head>
        ...
        <script type="text/javascript"
                src="http://maps.googleapis.com/maps/api/js?key=AIzaSyCb8RtLoXJEVH6pqnVV3s-RGb40VvBeTyI&sensor=false">
        </script>
        ...
        <script type="text/javascript" src="jquery.js"></script>
            ...
            //var locations = new  Array();
            function initialize() {
            var myLatlng = new google.maps.LatLng(32.729738,-97.113058);
            var myOptions = {
                zoom: 16,
                center: myLatlng,
